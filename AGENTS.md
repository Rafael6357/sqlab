...
- `ui/main_window.py` (~1090 líneas tras splits 1-3 + Fase 2: `ui/formato_sql.py`, `ui/dialogs.py`, `ui/tablas.py`, `ui/crono.py` (`CronoMixin`), `ui/paneles.py` (`PanelesMixin`); `MainWindow(CronoMixin, PanelesMixin, QMainWindow)`): ventana principal SQLab (HUD/logo/mission/matrix/consola, `work_splitter` editor|matriz, `status_db`, `exportar_resultado_csv`, dialogs custom `_show_custom_dialog`). Buscar por nombre de widget antes de leer completo.
- `tests/` (286 tests): `test_error_friendly.py` (14), `test_sqlite_engine.py` (20), `test_session_loader.py` (23), `test_e2e_smoke.py` (35), `test_cronometro.py` (20), `test_icono.py` (3), `test_fix_matriz.py` (6), `test_carga_tablas.py` (15), `test_ejemplos_empaquetados.py` (7), `test_carga_archivos.py` (14), `test_formato_sql.py` (12), `test_ui_nombres.py` (37), `test_visor_tablas.py` (6), `test_rendimiento.py` (7), `test_fix_carga_robusta.py` (5), `test_multi_sentencia.py` (7), `test_exportar_csv.py` (6), `test_mostrar_null.py` (6), `test_normalizar_nulos.py` (7), `test_scrollbars.py` (4), `test_abrir_db.py` (5), `test_autocompletar_enter.py` (5), `test_consola_vacia.py` (1), `test_exportar_excel.py` (3), `test_autocompletar_parentesis.py` (4), `test_compat_postgres.py` (6), `test_copiar_especificacion.py` (2), `test_historial_contraido.py` (3), `test_auto_espaciado.py` (3).
