...
- `tests/` (232 tests): `test_error_friendly.py` (14), `test_sqlite_engine.py` (20), `test_session_loader.py` (23), `test_e2e_smoke.py` (34), `test_cronometro.py` (20), `test_icono.py` (3), `test_fix_matriz.py` (6), `test_carga_tablas.py` (15), `test_ejemplos_empaquetados.py` (7), `test_carga_archivos.py` (11), `test_formato_sql.py` (12), `test_ui_nombres.py` (36), `test_visor_tablas.py` (6), `test_rendimiento.py` (7), `test_fix_carga_robusta.py` (5), `test_multi_sentencia.py` (7), `test_exportar_csv.py` (6).
