...
- `tests/` (302 tests): `test_error_friendly.py` (14), `test_sqlite_engine.py` (20), `test_session_loader.py` (23), `test_e2e_smoke.py` (35), `test_cronometro.py` (20), `test_icono.py` (3), `test_fix_matriz.py` (6), `test_carga_tablas.py` (15), `test_ejemplos_empaquetados.py` (7), `test_carga_archivos.py` (14), `test_formato_sql.py` (12), `test_ui_nombres.py` (37), `test_visor_tablas.py` (6), `test_rendimiento.py` (7), `test_fix_carga_robusta.py` (5), `test_multi_sentencia.py` (7), `test_exportar_csv.py` (6), `test_mostrar_null.py` (6), `test_normalizar_nulos.py` (7), `test_scrollbars.py` (4), `test_abrir_db.py` (5), `test_autocompletar_enter.py` (5), `test_consola_vacia.py` (1), `test_exportar_excel.py` (3), `test_autocompletar_parentesis.py` (4), `test_compat_postgres.py` (6), `test_copiar_especificacion.py` (2), `test_historial_contraido.py` (3), `test_auto_espaciado.py` (3), `test_exportar_db.py` (4), `test_comparar_consultas.py` (5), `test_graficos.py` (7).

## Changelog de contexto
- 2026-09: v29 — fix SDD (reporte: GRAFICAR mudo en el exe): handler nunca-silencioso (`GRAFICOS_DISPONIBLES` + motivo, `try/except` con traceback visible, spec GR-05); causa: excepción tragada antes del toast en windowed. Suite: 302 tests.
- 2026-09: v28 — análisis profesional B1-B3: `EXPORTAR DB` (backup API + roundtrip), `COMPARAR` historial (veredicto igualdad/diff, `core/comparar.py`), `GRAFICAR` QtCharts (barras/líneas + PNG, `PySide6-Addons`); A2 descartado a pedido. Suite: 299 tests.
- 2026-09: v27 — refactor Fase 3: `ui/carga.py` (`CargaMixin`: presets/ejercicio/tablas/aviso/status) y `ui/workspace.py` (`WorkspaceMixin`: builders misión/volcado/deck/editor/salida); `main_window.py` 1344→822 líneas (núcleo: ejecución/historial/sesión/exports); equivalencia verificada (suite + ruff en verde).
- 2026-09: v26 — análisis profesional (Fase 0 + P1-P12 + P9, 10 specs): Enter/Tab acepta autocompletado; botón CARGAR único; consola vacía inicial; EXPORTAR EXCEL; cierre de paréntesis; compat Postgres (`::`→CAST + hints, CAST/USING regresión); COPIAR especificación; REGLA DE ORO sin pistas; historial contraído; auto-espaciado proporcional. Suite: 286 tests.
- 2026-09: v25 — feature SDD (spec `scrollbars-visibles`): scrollbars de 4px/`#173834` (invisibles sin hover) a 12px con handle `#00aa70` redondeado + hover `#00ffaa`; sin flechas, sin variante clara; tests por texto QSS (patrón existente). Suite: 249 tests.
- 2026-09: v24 — refactor Fase 2: `ui/crono.py` (`CronoMixin`: builder + lógica CRONO/TEMPO) y `ui/paneles.py` (`PanelesMixin`: HUD/banner/pista/matriz + `_ruta_logo`); `main_window.py` 1429→1094 líneas; equivalencia verificada (245 tests + ruff en verde).
- 2026-09: v23 — bugfix SDD (spec `normalizar-nulos-csv-excel`, reporte con foto): CSV/Excel convertían solo `""`→`None` y las celdas con `" "` se veían vacías pese al render NULL de v21; helper `_es_nulo` (set pandas `{"", "-", "NA", "NULL", "null", "NaN"}` + strip) en `_parse_csv`/`_parse_excel` + relleno `None`; JSON intacto. Suite: 245 tests.
