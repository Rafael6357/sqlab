...
class PanelesMixin:
    ...
    def _build_matrix(self) -> QFrame:
        ...
        self.btn_comparar.setObjectName("GhostBtn")
        self.btn_comparar.setToolTip("Comparar dos consultas del historial (filas y columnas)")
        log_head.addWidget(self.btn_comparar)
