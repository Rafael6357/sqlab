...
- `tests/` (135 tests): `test_error_friendly.py` (12), `test_sqlite_engine.py` (16), `test_session_loader.py` (19), `test_e2e_smoke.py` (34), `test_cronometro.py` (20), `test_icono.py` (3), `test_fix_matriz.py` (6), `test_carga_tablas.py` (15).
